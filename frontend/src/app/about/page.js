...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      <div className="bg-white dark:bg-gray-800 py-12 sm:py-16 lg:py-24 transition-colors px-4 sm:px-6 border-b border-gray-200 dark:border-gray-700">
        <div className="max-w-6xl mx-auto w-full text-center">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">
            About <span className="text-green-600 dark:text-green-400">ChargeLoop</span>
          </h1>
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed px-2">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2">
            ...
            <button 
              ...
              className="bg-white dark:bg-gray-700 text-green-600 dark:text-green-400 border border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600 px-6 sm:px-8 py-3 rounded-lg text-base sm:text-lg font-semibold transition-colors duration-300 w-full sm:w-auto"
            >
              Become a Host
            </button>
          </div>
      ...
      {/* Mission & Vision */}
      <div className="py-12 sm:py-16 lg:py-20 bg-white dark:bg-gray-800 transition-colors px-4 sm:px-6">
        <div className="max-w-6xl mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">Our Mission</h2>
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <span className="text-gray-700 dark:text-gray-300 text-sm sm:text-base">Make EV charging accessible everywhere</span>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  <span className="text-green-600 dark:text-green-400 font-bold mt-1">✓</span>
                  <span className="text-gray-700 dark:text-gray-300 text-sm sm:text-base">Build a community-driven network</span>
                </div>
                <div className="flex items-start gap-3 sm:gap-4">
                  <span className="text-green-600 dark:text-green-400 font-bold mt-1">✓</span>
                  <span className="text-gray-700 dark:text-gray-300 text-sm sm:text-base">Contribute to a sustainable future</span>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="bg-white dark:bg-gray-700 rounded-lg p-6 sm:p-8 border border-gray-200 dark:border-gray-600 transition-colors font-semibold">
                <h3 className="text-2xl sm:text-3xl font-bold mb-4 text-gray-900 dark:text-white">Our Vision</h3>
      ...
      {/* Features Section */}
      <div className="bg-gray-50 dark:bg-gray-900 py-12 sm:py-16 lg:py-20 transition-colors px-4 sm:px-6">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((item, index) => (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-lg p-6 sm:p-8 text-center border border-gray-200 dark:border-gray-700 hover:border-green-200 dark:hover:border-green-700 transition-colors duration-300">
                ...
                <p className="leading-relaxed text-gray-600 dark:text-gray-300 text-sm sm:text-base">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {impact.map((item, index) => (
              <div key={index} className="text-center bg-gray-50 dark:bg-gray-700 rounded-lg p-6 sm:p-8 border border-gray-200 dark:border-gray-600">
                ...
                <h3 className="text-base sm:text-lg font-bold mb-2 sm:mb-3 text-gray-900 dark:text-white">{item.title}</h3>
      ...
      {/* CTA Section */}
      <div className="bg-white dark:bg-gray-800 py-12 sm:py-16 lg:py-20 transition-colors px-4 sm:px-6 border-t border-gray-200 dark:border-gray-700">
